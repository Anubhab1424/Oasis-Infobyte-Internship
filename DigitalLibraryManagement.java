...
class DigitalLibraryManagement{
    ...
    public void admin_login()
    {
        ...
        loginto.put("Anubhab",244);
        loginto.put("Reshma",240);
    ...
    public void user_login()
    {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Soumyadip",200);
        loginto.put("Sayandeep",201);
        loginto.put("Bhaskar",202);
        loginto.put("Zafar",203);
        loginto.put("Sayan",204);
